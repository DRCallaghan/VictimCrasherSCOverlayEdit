...
const modsImgs = {
    'nm': './static/mods/selection-mod-nomod.png',
    'ez': './static/mods/selection-mod-easy.png',
    'nf': './static/mods/selection-mod-nofail.png',
    'ht': './static/mods/selection-mod-halftime.png',
    'hr': './static/mods/selection-mod-hardrock.png',
    'sd': './static/mods/selection-mod-suddendeath.png',
    'pf': './static/mods/selection-mod-perfect.png',
    'dt': './static/mods/selection-mod-doubletime.png',
    'nc': './static/mods/selection-mod-nightcore.png',
    'hd': './static/mods/selection-mod-hidden.png',
    'fl': './static/mods/selection-mod-flashlight.png',
    'rx': './static/mods/selection-mod-relax.png',
    'ap': './static/mods/selection-mod-relax2.png',
    'so': './static/mods/selection-mod-spunout.png',
    'au': './static/mods/selection-mod-autoplay.png',
    'cn': './static/mods/selection-mod-cinema.png',
    'v2': './static/mods/selection-mod-scorev2.png',
    'tp': './static/mods/selection-mod-target.png',
};
...
socket.onmessage = event => {
    ...
    if (data.menu.bm.stats.SR != tempSr) {
        ...
        sr.innerHTML = `${Math.round(tempSr * 100) / 100}`;
    }
